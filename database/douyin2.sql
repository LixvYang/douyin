...
CREATE TABLE `video` (
	...
	primary key (`id`)
) ENGINE = InnoDB default CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '视频列表';
INSERT INTO `video` VALUES (1, 1, '熊', 'https://www.w3schools.com/html/movie.mp4', 'https://cdn.pixabay.com/photo/2016/03/27/18/10/bear-1283347_1280.jpg', 1, 0, 1257894000);
INSERT INTO `video` VALUES (2, 1, '熊二', 'https://www.w3schools.com/html/movie.mp4', 'https://cdn.pixabay.com/photo/2016/03/27/18/10/bear-1283347_1280.jpg', 1, 0, 1257894000);
...
) ENGINE = InnoDB default CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户关注表';
...
create table `comment` (
	...
	primary key (`id`)
) ENGINE = InnoDB default CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论列表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB default CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户喜欢的视频' ROW_FORMAT = DYNAMIC;
